...
import { ACTION_SCHEMAS, type ActionName } from '../../../src/services/actions/action-schemas.js';
import { getActionAcknowledgement, getActionConfirmationDescription } from '../../../src/services/actions/action-feedback.js';
...
const EXAMPLE_PARAMS: Record<ActionName, string> = {
  ...
  set_reminder: 'after=30m|text=Steuerberater anrufen',
  list_reminders: 'today',
  cancel_reminder: 'text=Steuerberater anrufen',
  lock_screen: '',
  media_play: '',
  media_pause: '',
  media_toggle: '',
