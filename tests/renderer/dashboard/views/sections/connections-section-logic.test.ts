...
import { toRowView, performAction } from '../../../../../src/renderer/dashboard/views/sections/connections-section-logic.js';
import type { ConnectionInfo, SarahConnectionsApi } from '../../../../../src/core/sarah-api.js';
